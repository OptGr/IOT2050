 ...
 * @extends {SdkClient}
 */
export declare class TrendPredictionClient extends SdkClient {
    private _baseUrl;
    /**
     ...
     */
    Train(modelData: TrendPredictionModels.TrainBody): Promise<TrendPredictionModels.ModelDto>;
    /**
     * Fits a regression model on the training dataset, storing the trained regression model in a database.
     *
     ...
     * @memberOf TrendPredictionClient
     */
    TrainDirect(modelData: TrendPredictionModels.TrainBodyDirect, params: {
        from: Date;
        to: Date;
     ...
     * @memberOf TrendPredictionClient
     */
    Predict(modelData: TrendPredictionModels.PredictBody): Promise<TrendPredictionModels.PredictionDataArray>;
    /**
     * Predicts future values of a given output variable using a pre-trained regression model.
     *
     ...
     * @memberOf TrendPredictionClient
     */
    PredictDirect(modelData: TrendPredictionModels.PredictBodyDirect, params: {
        from: Date;
        to: Date;
     ...
     * @memberOf TrendPredictionClient
     */
    TrainAndPredict(modelData: TrendPredictionModels.TrainPredictBody): Promise<TrendPredictionModels.PredictionDataArray>;
    /**
     ...
     * @memberOf TrendPredictionClient
     */
    TrainAndPredictDirect(modelData: TrendPredictionModels.TrainPredictBodyDirect, params: {
        trainFrom: Date;
        trainTo: Date;
        predictFrom: Date;
        predictTo: Date;
     ...
     * @memberOf TrendPredictionClient
     */
    GetModel(id: string): Promise<TrendPredictionModels.ModelDto>;
    /**
     ...
     * @memberOf TrendPredictionClient
     */
    DeleteModel(id: string): Promise<Object | undefined>;
}
