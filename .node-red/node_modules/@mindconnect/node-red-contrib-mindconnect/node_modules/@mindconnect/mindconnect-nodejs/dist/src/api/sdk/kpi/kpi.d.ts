 ...
 * @extends {SdkClient}
 */
export declare class KPICalculationClient extends SdkClient {
    private _baseUrl;
    /**
     ...
     */
    ComputeKPI(timeseries: KPICalculationModels.Timeseries, params: {
        from: Date;
        to: Date;
        variableName: string;
        initialState: string;
     ...
     * @memberOf KPICalculationClient
     */
    CaclulateKpiStates(requestParametersBundle: KPICalculationModels.RequestParametersBundle, params: {
        from: Date;
        to: Date;
        variableName: string;
        initialState: string;
        ...
        threshold: number;
        shutdownCorrelationThreshold: number;
    }): Promise<KPICalculationModels.KpiStateIndicationSet>;
    /**
     *
     * Launches kpi state computation task with specific parameters.
     *
     ...
     * @memberOf KPICalculationClient
     */
    CalculateKpiStatesDirect(requestParametersBundle: KPICalculationModels.RequestParametersBundleDirect, params: {
        from: Date;
        to: Date;
        assetId: string;
        aspectName: string;
