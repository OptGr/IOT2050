...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const agent = new __1.MindConnectAgent(configuration);
        const log = (text) => {
        ...
        if (!agent.IsOnBoarded()) {
            ...
            yield (0, __1.retry)(RETRYTIMES, () => agent.OnBoard());
            log("Agent onboarded");
        }
        ...
        const config = yield agent.GenerateDataSourceConfiguration(targetAssetType);
        // create/overwrite the data source configuration
        yield agent.PutDataSourceConfiguration(config);
        ...
        yield agent.ConfigureAgentForAssetId(targetAssetId);
        // Check in the local agent state storage if agent has data source configuration.
        if (!agent.HasDataSourceConfiguration()) {
            yield (0, __1.retry)(RETRYTIMES, () => agent.GetDataSourceConfiguration());
        ...
        for (let index = 0; index < 5; index++) {
            try {
                ...
                yield (0, __1.retry)(RETRYTIMES, () => agent.PostData(values));
                log("Data posted");
                yield sleep(1000);
                const event = {
                ...
                yield (0, __1.retry)(RETRYTIMES, () => agent.PostEvent(event));
                log("event posted");
                yield sleep(1000);
                // upload file
                ...
                yield agent.UploadFile(agent.ClientId(), "custom/mindsphere/path/package.json", "package.json", {
                    retry: RETRYTIMES,
                ...
                yield (0, __1.retry)(RETRYTIMES, () => agent.BulkPostData(bulk));
