    ...
    program
        ...
        (() => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                (0, command_utils_1.verboseLog)(`Deleting file ${color(fileInfo[0].name)} with size of ${color((0, command_utils_1.humanFileSize)(fileInfo[0].size || 0))} from MindSphere.`, options.verbose, spinner);
                yield (0, utils_1.retry)(options.retry, () => iotFileClient.DeleteFile(options.assetid, fullpath));
        ...
        .on("--help", () => {
        (0, console_1.log)("\n  Examples:\n");
        (0, console_1.log)(`    mc delete-file -f CHANGELOG.md  --assetid 5..f  \t\t\t\t delete file ${color("CHANGELOG.md")} from specified asset`);
        (0, console_1.log)(`    mc delete-file --file  CHANGELOG.md  --assetid 5...f --filepath upload \t delete file ${color("upload/CHANGELOG.md")} from specified asset`);
        (0, console_1.log)(`    mc delete-file --file  upload/CHANGELOG.md  --assetid 5...f \t\t delete file ${color("upload/CHANGELOG.md")} from specified asset`);
        (0, command_utils_1.serviceCredentialLog)();
    });
};
function checkRequiredParameters(options) {
    !options.file &&
        (0, command_utils_1.errorLog)("Missing file name for delete-file command. Run mc de --help for full syntax and examples.", true);
    !options.assetid && (0, command_utils_1.errorLog)(" You have to specify assetid. Run  mc de --help for full syntax and examples.", true);
}
