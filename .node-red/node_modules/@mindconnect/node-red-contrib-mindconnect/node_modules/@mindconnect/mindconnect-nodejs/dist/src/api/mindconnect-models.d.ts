 ...
 * @enum {number}
 */
export declare enum ConfigurationStyle {
    Numeric = "NUMERIC",
 ...
 */
export declare namespace ClientIdentifier {
    /**
     * @export
     * @enum {string}
     */
...
export declare namespace DataPoint {
    ...
    type DataPointType = "INT" | "LONG" | "DOUBLE" | "BOOLEAN" | "STRING" | "TIMESTAMP" | "BIG_STRING";
}
/**
 *
 * @export
...
export declare type MessageEncoding = "ascii" | "utf8" | "utf16le" | "ucs2" | "base64" | "latin1" | "binary" | "hex";
...
export declare namespace OnlineStatus {
    /**
     * @export
     * @enum {string}
     */
