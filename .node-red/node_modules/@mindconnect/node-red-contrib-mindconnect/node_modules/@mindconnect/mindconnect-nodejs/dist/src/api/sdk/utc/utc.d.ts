 ...
 * @extends {SdkClient}
 */
export declare class UsageTransparencyClient extends SdkClient {
    private _baseUrl;
    /**
     ...
     */
    PostUsages(usageData: UsageTransparencyModels.UserUsage): Promise<Object | undefined>;
    /**
     ...
     * @memberOf UsageTransparencyClient
     */
    PostUsagesJobs(usages: UsageTransparencyModels.Users): Promise<UsageTransparencyModels.UsagesJob>;
    /**
     ...
     * @memberOf UsageTransparencyClient
     */
    GetUsagesJobsById(id: string, params?: {
        page?: number;
        size?: number;
     ...
     * @memberOf UsageTransparencyClient
     */
    GetUsagesJobsByIdErrors(id: string, params?: {
        errorClass?: string;
        page?: number;
        size?: number;
