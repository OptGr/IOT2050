...
exports.UsageTransparencyClient = void 0;
 ...
 * @extends {SdkClient}
 */
class UsageTransparencyClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/api/usagetransparency/v3";
    }
    /**
     ...
     * @memberOf UsageTransparencyClient
     */
    GetUsagesJobs(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
                baseUrl: `${this._baseUrl}/usagesJobs?${(0, utils_1.toQueryString)(params)}`,
            }));
        });
    }
    /**
     ...
     * @memberOf UsageTransparencyClient
     */
    GetUsagesJobsById(id, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
                baseUrl: `${this._baseUrl}/usagesJobs/${id}?${(0, utils_1.toQueryString)(params)}`,
            }));
        });
    }
    /**
     ...
     * @memberOf UsageTransparencyClient
     */
    GetUsagesJobsByIdErrors(id, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
                baseUrl: `${this._baseUrl}/usagesJobs/${id}/errors?${(0, utils_1.toQueryString)(params)}`,
            }));
        });
    }
}
exports.UsageTransparencyClient = UsageTransparencyClient;
