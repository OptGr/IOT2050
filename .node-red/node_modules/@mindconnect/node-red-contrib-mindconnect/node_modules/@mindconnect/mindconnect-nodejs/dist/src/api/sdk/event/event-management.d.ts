...
export declare class EventManagementClient extends SdkClient {
    private _baseUrl;
    /**
     ...
     */
    GetBillboard(): Promise<EventManagementModels.InfoResponse>;
    /**
     * * Events
     *
     ...
     * @memberOf EventManagementClient
     */
    PostEvent(event: EventManagementModels.CustomEvent, params?: {
        includeShared?: boolean;
     ...
     * @memberOf EventManagementClient
     */
    PutEvent(eventId: string, event: EventManagementModels.CustomEvent, params: {
        ifMatch: number;
        includeShared?: boolean;
     ...
     * @memberOf EventManagementClient
     */
    PostEventType(eventType: EventManagementModels.EventType, params?: {
        includeShared?: boolean;
     ...
     * @memberOf EventManagementClient
     */
    GetEventType(eventTypeId: string, params?: {
        ifNoneMatch?: string;
        includeShared?: boolean;
    }): Promise<EventManagementModels.EventTypeResponse>;
    /**
     ...
     * @memberOf EventManagementClient
     */
    PatchEventType(eventTypeId: string, eventTypePatch: EventManagementModels.EventTypePatch, params: {
        ifMatch: number;
        includeShared?: boolean;
    }): Promise<EventManagementModels.EventTypeResponse>;
    /**
     ...
     * @memberOf EventManagementClient
     */
    DeleteEventType(eventTypeId: string, params: {
        ifMatch: number;
        includeShared?: boolean;
     ...
     * @memberOf EventManagementClient
     */
    PostDeleteEventsJob(deleteEventsJob: EventManagementModels.DeleteEventsJob): Promise<EventManagementModels.JobResource>;
    /**
     * * Jobs
     *
     ...
     * @memberOf EventManagementClient
     */
    GetDeleteEventsJob(jobId: string): Promise<EventManagementModels.DeleteJobResource>;
    /**
     * * Jobs
     *
     ...
     * @memberOf EventManagementClient
     */
    PostCreateEventsJob(createEventsJob: EventManagementModels.DeleteEventsJob): Promise<EventManagementModels.JobResource>;
    /**
     ...
     * @memberOf EventManagementClient
     */
    GetCreateEventsJob(jobId: string): Promise<EventManagementModels.CreateJobResource>;
}
