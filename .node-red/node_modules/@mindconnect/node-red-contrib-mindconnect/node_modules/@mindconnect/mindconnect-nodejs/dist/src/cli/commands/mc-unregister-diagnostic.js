    ...
    program
        ...
        (() => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                (0, command_utils_1.verboseLog)(`unregistering from diagnostic with agent id ${color(agentid)}`, options.verbose);
                yield mcApiClient.DeleteDiagnosticActivation(agentid);
                (0, command_utils_1.verboseLog)(`successfully unregistered the agent with agent id ${color(agentid)} from diagnostic`, true);
            }
            catch (err) {
        ...
        .on("--help", () => {
        (0, console_1.log)(`\n  Examples:\n`);
        (0, console_1.log)(`    mc ud -k mypasskey`);
        (0, console_1.log)(`    mc unregister-diagnostic --config someagent.json -passkey mypasskey`);
