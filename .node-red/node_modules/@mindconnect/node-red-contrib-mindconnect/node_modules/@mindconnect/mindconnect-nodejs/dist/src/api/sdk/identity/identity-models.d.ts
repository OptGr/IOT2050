export declare namespace IdentityManagementModels {
    /**
     *
     * @export
     * @class RequiredError
     ...
     */
    interface ClientSecretCreationTimes extends Array<number> {
    }
    /**
     *
     * @export
     ...
     */
    interface ScimGroupMemberList extends Array<ScimGroupMember> {
    }
    /**
     *
     * @export
