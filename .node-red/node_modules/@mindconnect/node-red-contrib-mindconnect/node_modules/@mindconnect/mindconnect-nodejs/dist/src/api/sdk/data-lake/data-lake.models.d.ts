export declare namespace DataLakeModels {
    /**
     *
     * @export
     * @class RequiredError
     ...
     */
    interface DownloadObjectUrls extends Array<ObjectUrlsInner> {
    }
    /**
     ...
     */
    interface ImportJobDetails extends ImportJobResponse {
        /**
     ...
     */
    interface ObjectUrls extends Array<ObjectUrlsInner> {
    }
    /**
     *
     * @export
     ...
     * @interface Sort
     */
    interface Sort extends Array<SortCriteria> {
    }
    /**
     *
     * @export
